...
function pobierzDane(event) {
    ajax({
        ...
        onSuccess: function (response) {
            ...
            var jsonObj = JSON.parse(response);
            console.log(jsonObj);
            document.getElementById("data1").innerHTML = 'User ID:' + jsonObj.userId;
            document.getElementById("data2").innerHTML = 'User name: ' + jsonObj.userName;
            document.getElementById("data3").innerHTML = 'User ID: ' + jsonObj.userURL;
